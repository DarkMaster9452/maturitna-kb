              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'start', marginBottom: 16 }}>
                ...
                <div style={{ display: 'flex', gap: 8 }}>
                  ...
                  <button onClick={() => toggleSelect(s.id)} title={isSelected ? 'Odstrániť z plánu' : 'Pridať do plánu'}
                    style={{ width: 32, height: 32, borderRadius: 8, background: isSelected ? 'var(--primary)' : 'var(--surface-container)', border: 'none', cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', color: isSelected ? 'var(--on-primary)' : 'var(--on-surface-variant)', transition: 'all .2s' }}>
